...
const require$$1$2 = require('fs/promises');
...
const require$$1__default$2 = /*#__PURE__*/_interopDefaultCompat(require$$1$1);
...
function requirePrompt () {
	...
	const readline = require$$0__default;
...
async function detect$1(options = {}) {
...
var supportsHyperlinksExports = requireSupportsHyperlinks();
...
const require$1 = node_module.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('shared/ni.jp8Y2gho.cjs', document.baseURI).href)));
var St = Object.create;
var $ = Object.defineProperty;
var kt = Object.getOwnPropertyDescriptor;
var Tt = Object.getOwnPropertyNames;
var At = Object.getPrototypeOf, Rt = Object.prototype.hasOwnProperty;
var h = /* @__PURE__ */ ((t) => typeof require$1 < "u" ? require$1 : typeof Proxy < "u" ? new Proxy(t, {
  get: (e, n) => (typeof require$1 < "u" ? require$1 : e)[n]
}) : t)(function(t) {
...
function Ft(t, e) {
  let n = e.value.split(require$$1$1.delimiter), r = t, s;
  do
    n.push(require$$1$1.resolve(r, "node_modules", ".bin")), s = r, r = require$$1$1.dirname(r);
  while (r !== s);
  return { key: e.key, value: n.join(require$$1$1.delimiter) };
}
function I(t, e) {
  let n = {
    ...process.env,
...
var L = (t) => {
  let e = t.length, n = new stream.PassThrough(), r = () => {
    --e === 0 && n.emit("end");
  };
  for (let s of t)
...
function we(t, e) {
  return {
    command: require$$1$1.normalize(t),
    args: e ?? []
  };
}
function xe(t) {
...
var R = class {
  ...
  async *[Symbol.asyncIterator]() {
    ...
    let r = L(n), s = require$$0__default.createInterface({
      input: r
    });
...
function requirePosix () {
	...
	const fs_1 = require$$0__default$2;
...
function requireCjs () {
	...
	(function (exports) {
		...
		var __exportStar = (cjs.__exportStar) || function(m, exports) {
...
function requireLib () {
	...
	const { join, delimiter, sep, posix } = require$$1__default$2;
...
const CLI_TEMP_DIR = path.join(os__default.tmpdir(), "antfu-ni");
...
async function getConfig() {
  if (!config) {
    config = Object.assign(
      {},
      defaultConfig,
      fs__default.existsSync(rcPath) ? ini.parse(fs__default.readFileSync(rcPath, "utf-8")) : null
    );
    if (process__default.env.NI_DEFAULT_AGENT)
      config.defaultAgent = process__default.env.NI_DEFAULT_AGENT;
    if (process__default.env.NI_GLOBAL_AGENT)
      config.globalAgent = process__default.env.NI_GLOBAL_AGENT;
...
async function run(fn, args, options = {}) {
  ...
  if (args.length === 1 && (args[0]?.toLowerCase() === "-v" || args[0] === "--version")) {
    ...
    const getV = (a) => {
      ...
      return ve(command2, args2, xVersionOptions).then((e) => e.stdout).then((e) => e.startsWith("v") ? e : `v${e}`);
    };
...
exports.formatPackageWithUrl = formatPackageWithUrl;
